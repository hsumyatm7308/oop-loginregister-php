...
class Logout extends Connection{
    public function logoutUser($id){
        $logout_result = $this->conn->prepare("SELECT * FROM loginregister id = :id");
        $logout_result->bindParam(":id",$id);
        $logout_result->execute();
        $row = $logout_result->fetch(PDO::FETCH_ASSOC);
